...
var demoCalls = []struct {
	...
	{Tool: "server_info"},
	{Tool: "list_animals", Args: map[string]any{"class": "птицы"}},
	{Tool: "get_animal", Args: map[string]any{"animal": "Lynx lynx"}},
	// Отсутствие записи — тоже результат: сервер отвечает found=false и
	// показывает, что у него есть похожего, вместо выдуманной карточки.
	{Tool: "get_animal", Args: map[string]any{"animal": "малая выхухоль"}},
}
